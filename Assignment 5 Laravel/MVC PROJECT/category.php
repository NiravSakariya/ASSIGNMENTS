		...
		<div class="row">
					...
					<ul class="main-categories">
						<li class="main-nav-list"><a data-toggle="collapse" href="#fruitsVegetable" aria-expanded="false" aria-controls="fruitsVegetable"><span
							...
							<ul class="collapse" id="fruitsVegetable" data-toggle="collapse" aria-expanded="false" aria-controls="fruitsVegetable">
								<li class="main-nav-list child"><a href="#">Frozen Dish<span class="number">(13)</span></a></li>
								<li class="main-nav-list child"><a href="#">Dried Dish<span class="number">(09)</span></a></li>
								<li class="main-nav-list child"><a href="#">Fresh Dish<span class="number">(17)</span></a></li>
								<li class="main-nav-list child"><a href="#">Vegitable Alternatives<span class="number">(01)</span></a></li>
								<li class="main-nav-list child"><a href="#">Vegitable<span class="number">(11)</span></a></li>
							</ul>
						</li>

						<li class="main-nav-list"><a data-toggle="collapse" href="#meatFish" aria-expanded="false" aria-controls="meatFish"><span
								 class="lnr lnr-arrow-right"></span>Vegitable and Dish<span class="number">(53)</span></a>
						...
						<li class="main-nav-list"><a class="border-bottom-0" data-toggle="collapse" href="#babyCare" aria-expanded="false"
							...
							<ul class="collapse" id="babyCare" data-toggle="collapse" aria-expanded="false" aria-controls="babyCare">
								...
								<li class="main-nav-list child"><a href="#">Fresh Dish<span class="number">(17)</span></a></li>
								<li class="main-nav-list child"><a href="#">Vegitable Alternatives<span class="number">(01)</span></a></li>
								<li class="main-nav-list child"><a href="#" class="border-bottom-0">Vegitable<span class="number">(11)</span></a></li>
							</ul>
						</li>
					</ul>
				</div>
			...
			<div class="col-xl-9 col-lg-8 col-md-7">
				...
				<section class="lattest-product-area pb-40 category-list">
					<div class="row">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="admin/<?php echo $product1["image"]; ?>" alt="" style="height:240px; width:240px;">
								<div class="product-details">
									<h6><?php echo $product1["name"]; ?></h6>
									<div class="price">
										<h6>Rs.<?php echo $product1["offerprice"]; ?>.00</h6>
										<h6 class="l-through">Rs.<?php echo $product1["price"]; ?>.00</h6>
										<details>
					...
					{
					?>
									<a href="login" class="social-info" onclick="return confirm('Login First For Shopping')">
					...
					{
					?>
									<a href="cart?addtocart" class="social-info" >
										<span class="ti-bag"></span>
										<p class="hover-text">add to bag</p>
									</a>
					<?php 
						...
						<div class="col-lg-4 col-md-4 col-sm-6 mb-20">
							<div class="single-related-product d-flex">
								...
								<div class="desc">
									...
									<div class="price">
										<h6>Rs.1890.00</h6>
										<h6 class="l-through">Rs.2100.00</h6>
									</div>
								</div>
							</div>
						</div>
